...
[![Product Overview][product-overview]](https://example.com)

Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `CupofCuppuccino`, `D-vidlization`, `twitter_handle`, `linkedin_username`, `1928356570`, `1928356570_client`, `project_title`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/CupofCuppuccino/D-vidlization.git
   ```
